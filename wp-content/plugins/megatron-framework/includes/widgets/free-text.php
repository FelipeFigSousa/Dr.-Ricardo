...
class G5Plus_Widget_Free_Text extends  g5plus_acf_widget {
    public function __construct() {
        ...
        $this->widget_description = esc_html__( "Display image, free text and link", 'g5plus-megatron' );
        $this->widget_id          = 'megatron-free-text';
        $this->widget_name        = esc_html__( 'G5Plus: Free Text', 'g5plus-megatron' );
        ...
        $this->settings           = array(
            ...
            'extra'     => array(
                ...
                array(
                    ...
                    'title'   => esc_html__( 'Free text align',  'g5plus-megatron'),
                    'type'    => 'select',
                    'std'     => '',
                    'allow_clear' => '1',
                    'options' => array(
                ...
                array(
                    'name'   => 'link_type',
                    'title'   => esc_html__( 'Link type',  'g5plus-megatron'),
                    'type'    => 'select',
                    'std'     => '',
                    'allow_clear' => '1',
                    'options' => array(
                        'custom'  => esc_html__( 'Custom', 'g5plus-megatron' ),
                        'post' => esc_html__( 'Post',  'g5plus-megatron' ),
                        'page' => esc_html__( 'page',  'g5plus-megatron' )
                    )
                ),
                array(
                    'name'  => 'link_outside',
                ...
                array(
                    'name'   => 'link_post',
                    'title'   => esc_html__( 'Link read more',  'g5plus-megatron'),
                    'type'    => 'select',
                    'std'     => '',
                    'allow_clear' => '1',
                    'options' => $list_post,
                ...
                array(
                    'name'   => 'open_type',
                    'title'   => esc_html__( 'Open type',  'g5plus-megatron'),
                    'type'    => 'select',
                    'std'     => '',
                    'allow_clear' => '1',
                    'options' => array(
                        '_blank'  => esc_html__( 'New window', 'g5plus-megatron' ),
                        '_self' => esc_html__( 'In this window',  'g5plus-megatron' ),
                    )
                ),
            )
        );
    ...
    function widget( $args, $instance ) {
        ...
        <div class="slideshow-images">
            ...
            <?php if($image_url!=''){ ?>
                <div class="image">
                    <?php
                        ...
                        ?>
                        <img src="<?php echo esc_url($image_url)?>" alt="<?php echo esc_html__( 'Image Free Text Widget',  'g5plus-megatron' ) ?>" />
                </div>
            <?php } ?>
            ...
            <?php if($link!=''){ ?>
                <div class="link">
                    <a class="s-color p-font" href="<?php echo esc_url($link) ?>" target="<?php echo esc_attr($open_type) ?>"><?php echo esc_html__( 'Read more',  'g5plus-megatron' ) ?></a>
                </div>
            <?php } ?>
        </div>
        <?php
...
if (!function_exists('g5plus_register_widget_free_text')) {
    function g5plus_register_widget_free_text() {
        ...
        if(function_exists('vc_map')){
            ...
            vc_map( array(
                'name' => 'G5Plus ' . esc_html__( 'Free Text','g5plus-megatron'),
                'base' => 'g5plusframework_widget_free_text',
                'icon' => 'fa fa-text-width',
                'category' => esc_html__( 'Megatron Widgets', 'g5plus-megatron' ),
                'class' => 'wpb_vc_wp_widget',
                'weight' => - 50,
                'description' => esc_html__( 'A custome free text for your site', 'g5plus-megatron' ),
                'params' => array(
                    array(
                        'type' => 'textfield',
                    ...
                    array(
                        'type' => 'textfield',
                        'heading' => esc_html__( 'Title free text', 'g5plus-megatron' ),
                        'param_name' => 'title_free_text'
                    ),
                    array(
                        'type' => 'textarea',
                        'heading' => esc_html__( 'Free text', 'g5plus-megatron' ),
                        'param_name' => 'free_text'
                    ),
                    array(
                        'type' => 'dropdown',
                        'heading' => esc_html__( 'Free text align', 'g5plus-megatron' ),
                    ...
                    array(
                        'type' => 'dropdown',
                        'heading' => esc_html__( 'Link Type', 'g5plus-megatron' ),
                        'param_name' => 'link_type',
                        'value' => array(
                            esc_html__( 'custom', 'g5plus-megatron' )  => 'custom',
                            esc_html__( 'post',  'g5plus-megatron' ) => 'post',
                            esc_html__( 'page',  'g5plus-megatron' ) => 'page'
                        )
                    ),
                    array(
                        'type' => 'textfield',
                        'heading' => esc_html__( 'Link read more', 'g5plus-megatron' ),
                    ...
                    array(
                        'type' => 'dropdown',
                        'heading' => esc_html__( 'Open type', 'g5plus-megatron' ),
                        'param_name' => 'open_type',
                        'value' => array(
                            esc_html__( 'New window', 'g5plus-megatron' )  => '_blank',
                            esc_html__( 'In this window',  'g5plus-megatron' ) => '_self'
                        )
                    )
                )
            ) );
