...
class G5Plus_Widget_Partner_Carousel extends  g5plus_acf_widget {
    public function __construct() {
        ...
        $this->widget_description = esc_html__( "Display partner that declare in Theme Option", 'g5plus-megatron' );
        $this->widget_id          = 'megatron-partner-carousel';
        $this->widget_name        = esc_html__( 'G5Plus: Partner Carousel', 'g5plus-megatron' );
        $this->settings           = array(
            'id'          => 'partner_carousel_acf',
            'type'        => 'rows',
            'title'       => esc_html__('Partner Carousel', 'g5plus-megatron'),
            'fields'      => array(
                array(
                    'name' => 'partner_name',
                    'title' => 'Partner name',
            ...
            'extra' => array(
                array(
                    ...
                    'title'   => esc_html__( 'Display top line', 'g5plus-megatron' ),
                    'type'    => 'select',
                    'std'     => '',
                    'allow_clear' => '1',
                    //'multiple' => '1',
                    'options' => array(
                        ''  => esc_html__( 'No', 'g5plus-megatron' ),
                        'border-top-gray' => esc_html__( 'Yes', 'g5plus-megatron' )
                    )
                ),
            )
        );
