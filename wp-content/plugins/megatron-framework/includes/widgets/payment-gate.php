...
class G5Plus_Widget_Payment_Gate extends  g5plus_acf_widget {
    public function __construct() {
        ...
        $this->widget_description = esc_html__( "Display logo payment gates that declare in Theme Option", 'g5plus-megatron' );
        $this->widget_id          = 'megatron-payment-gate';
        $this->widget_name        = esc_html__( 'G5Plus: Payment Gate', 'g5plus-megatron' );
        $this->settings           = array(
            'id'          => 'payment_gates_acf',
            'type'        => 'rows',
            'title'       => esc_html__('Payment gate', 'g5plus-megatron'),
            'subtitle'    => esc_html__('Unlimited Payment gate logo with drag and drop sortings.', 'g5plus-megatron'),
            'fields'      => array(
                array(
