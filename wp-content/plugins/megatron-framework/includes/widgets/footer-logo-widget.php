...
class G5Plus_Widget_Footer_Logo extends  G5Plus_Widget {
    public function __construct() {
        ...
        $this->widget_description = esc_html__( "Logo and sub description", 'g5plus-megatron' );
        $this->widget_id          = 'megatron-footer-logo';
        $this->widget_name        = esc_html__( 'G5Plus: Footer Logo', 'g5plus-megatron' );
        $this->settings           = array(
	        'image' => array(
		        'type' => 'image',
		        'std' => '',
		        'label' => esc_html__('Image','g5plus-megatron')
	        ),
	        'alt' => array(
		        'type' => 'text',
		        'std' => '',
		        'label' => esc_html__('Image Alt','g5plus-megatron')
	        ),
            'sub_description'  => array(
                'type'  => 'text-area',
                'std'   => '',
                'label' => esc_html__( 'Sub Description', 'g5plus-megatron' )
            ),
	        'read_more' =>  array(
		        'type' => 'text',
		        'std' => '',
		        'label' => esc_html__('Read More Link','g5plus-megatron')
	        )
        );
        parent::__construct();
    }
        ...
        <div class="footer-logo">
	        ...
	        <?php if (!empty($read_more)) : ?>
		        <div class="footer-logo-read-more">
			        <span><i class="fa fa-angle-right"></i></span> <a href="<?php echo esc_url($read_more); ?>"><?php esc_html_e('Read more','g5plus-megatron') ?></a>
		        </div>
	        <?php endif; ?>
        </div>
        <?php
