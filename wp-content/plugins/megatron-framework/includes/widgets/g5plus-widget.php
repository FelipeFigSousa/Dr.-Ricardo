				...
				case "icon":
					...
					<div style="margin: 13px 0">
						...
						<div>
							...
							<input style="float: right"  title="<?php echo esc_html__('Click to browse icon','g5plus-megatron') ?>" class="browse-icon button-secondary" type="button" value="<?php echo esc_html__('Browse...','g5plus-megatron') ?>" />
				...
				case "image":
					...
					<div style="margin: 13px 0">
						...
						<div class="widget-image-field">
							...
							<button style="float: right" title="<?php echo esc_html__('Click to browse image','g5plus-megatron') ?>" class="browse-images button-secondary" type="button"><?php echo esc_html__('Browse...','g5plus-megatron') ?></button>
						</div>
