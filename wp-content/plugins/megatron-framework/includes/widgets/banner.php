...
class G5Plus_Widget_Banner extends G5Plus_Widget {
	public function __construct() {
		...
		$this->widget_description =  esc_html__( "Banner Widget", 'g5plus-megatron' );
		$this->widget_id          = 'g5plus-banner';
		$this->widget_name        = esc_html__( 'G5Plus: Banner', 'g5plus-megatron' );
		$this->settings           = array(
			'title' => array(
				'type' => 'text',
				'std' => '',
			...
			'link' => array(
				'type' => 'text',
				'std' => '',
				'label' => esc_html__('Link','g5plus-megatron')
			),
			'target' => array(
				'type' => 'checkbox',
				'std' => '',
				'label' => esc_html__('Open link in a new window/tab','g5plus-megatron')
			),
		);
		parent::__construct();
	}
