...
if (!class_exists('g5plusFramework_ShortCode_Button')) {
    class g5plusFramework_ShortCode_Button
    {
        ...
        {
            add_shortcode('megatron_button', array($this, 'button_shortcode'));
        }
        ...
        function button_shortcode($atts)
        {
            ...
            $atts = vc_map_get_attributes( 'megatron_button', $atts );
            extract( $atts );
            ...
            $button_class = array('m-button', $layout_style, $size, $button_color, $g5plus_animation);
            if($add_icon == 'yes'){
