...
if (!class_exists('g5plusFramework_Shortcode_Slider_Container')) {
	class g5plusFramework_Shortcode_Slider_Container
	{
		...
		{
			add_shortcode('megatron_slider_container', array($this, 'slider_container_shortcode'));
		}
		...
		function slider_container_shortcode($atts, $content)
		{
			...
			$atts = vc_map_get_attributes( 'megatron_slider_container', $atts );
			extract( $atts );
...
if ( class_exists( 'WPBakeryShortCodesContainer' ) ) {
    class WPBakeryShortCode_megatron_slider_container extends WPBakeryShortCodesContainer {
    }
}