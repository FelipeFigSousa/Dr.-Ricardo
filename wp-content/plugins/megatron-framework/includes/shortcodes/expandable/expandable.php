...
if (!class_exists('g5plusFramework_Shortcode_Expandable')) {
	class g5plusFramework_Shortcode_Expandable
	{
		...
		{
			add_shortcode('megatron_expandable', array($this, 'expandable_shortcode'));
		}
		...
		function expandable_shortcode($atts, $content)
		{
            ...
            $atts = vc_map_get_attributes( 'megatron_expandable', $atts );
            extract( $atts );
            ...
            wp_enqueue_script('megatron_expandable_js', plugins_url('megatron-framework/includes/shortcodes/expandable/assets/js/expandable' . $min_suffix_js . '.js'), array(), false, true);
            wp_enqueue_style('megatron_expandable_css', plugins_url('megatron-framework/includes/shortcodes/expandable/assets/css/expandable' . $min_suffix_css . '.css'), array(), false);
...
if ( class_exists( 'WPBakeryShortCodesContainer' ) ) {
    class WPBakeryShortCode_megatron_expandable extends WPBakeryShortCodesContainer {
    }
}
?>