...
if (!class_exists('g5plusFramework_Shortcode_Partner_Carousel')) {
    class g5plusFramework_Shortcode_Partner_Carousel
    {
        ...
        {
            add_shortcode('megatron_partner_carousel', array($this, 'partner_carousel_shortcode'));
        }
        ...
        function partner_carousel_shortcode($atts)
        {
            ...
            $atts = vc_map_get_attributes('megatron_partner_carousel', $atts);
            extract($atts);
            ...
            wp_enqueue_style('megatron_partner_carousel_css', plugins_url('megatron-framework/includes/shortcodes/partner-carousel/assets/css/partner-carousel' . $min_suffix_css . '.css'), array(), false);
            ...
            {
                $data_carousel[]='"margin":2';
            }
            elseif($layout_style=='style3')
            {
                $data_carousel[]='"margin":-1';
            }
            else
            {
            ...
            ob_start(); ?>
            <div class="partner-carousel <?php echo esc_attr($layout_style.$opacity . $g5plus_animation) ?>" <?php echo g5plusFramework_Shortcodes::g5plus_get_style_animation($duration, $delay); ?>>
