...
<div class="portfolio-custom-field">
    ...
    <p>
        <a href="#" class="docopy-portfolio_custom_fields button"><?php esc_html_e('Add custom field', 'g5plus-megatron'); ?></a>

        <a href="#" class="dodelete-portfolio_custom_fields button"><?php esc_html_e('Remove All', 'g5plus-megatron'); ?></a>
    </p>
</div>
