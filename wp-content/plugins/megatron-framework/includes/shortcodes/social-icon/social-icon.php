...
if (!class_exists('g5plusFramework_Shortcode_Social_Icon')) {
    class g5plusFramework_Shortcode_Social_Icon
    {
        ...
        {
            add_shortcode('megatron_social_icon', array($this, 'social_icon_shortcode'));
        }
        function social_icon_shortcode($atts)
        {
            ...
            $atts = vc_map_get_attributes( 'megatron_social_icon', $atts );
            extract( $atts );
            ...
            wp_enqueue_style('megatron_social_icon_css', plugins_url('megatron-framework/includes/shortcodes/social-icon/assets/css/social-icon' . $min_suffix_css . '.css'), array(), false);
