...
<article id="post-<?php the_ID(); ?>" <?php post_class($class); ?>>
    ...
    <div class="entry-content-wrap">
        ...
        <div class="entry-content-footer social-share-hover">
            <a class="m-button m-button-3d m-button-primary m-button-xs" href="<?php the_permalink(); ?>" rel="bookmark" title="<?php the_title(); ?>"><?php esc_html_e('Saiba Mais','g5plus-megatron') ?></a>
            <?php g5plus_share(); ?>
        </div>
    </div>
</article>
